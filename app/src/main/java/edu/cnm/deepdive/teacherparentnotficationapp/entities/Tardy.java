...
@DatabaseTable(tableName = "TARDIES")
public class Tardy {
  ...
  @DatabaseField(columnName = "TARDIES_ID", generatedId = true)
  private int id;

  @DatabaseField(columnName = "STUDENT_ID", canBeNull = false,
      foreign = true, foreignAutoRefresh = true, uniqueCombo = true)
  private Student student;


  @DatabaseField(columnName = "DATE", format = "yyyy-MM-dd", canBeNull = false, uniqueCombo = true)
  private Date date;
